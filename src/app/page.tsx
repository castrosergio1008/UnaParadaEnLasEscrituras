        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-emerald-700 hover:bg-emerald-600/20 text-emerald-400 font-medium px-6 py-3 rounded-full transition-colors"
            >
